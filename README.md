...
This is pretty much a direct port of the gmod 10 scoreboard over to 13, ratings and everything work with added DarkRP support.

Installation (for servers):
Download the .zip, extract gmod10_scoreboard to your addons folder, and restart your server.
